	...
	try {
		...
		switch (requestBody.name) {
			case 'slack_list_channels': {
				const args = requestBody.arguments as unknown as ListChannelsArgs;
			...
			case 'slack_post_message': {
				const args = requestBody.arguments as unknown as PostMessageArgs;
			...
			case 'slack_reply_to_thread': {
				const args = requestBody.arguments as unknown as ReplyToThreadArgs;
			...
			case 'slack_add_reaction': {
				const args = requestBody.arguments as unknown as AddReactionArgs;
			...
			case 'slack_get_channel_history': {
				const args = requestBody.arguments as unknown as GetChannelHistoryArgs;
				if (!args.channel_id) {
			...
			case 'slack_get_thread_replies': {
				const args = requestBody.arguments as unknown as GetThreadRepliesArgs;
			...
			case 'slack_get_users': {
				const args = requestBody.arguments as unknown as GetUsersArgs;
			...
			case 'slack_get_user_profile': {
				const args = requestBody.arguments as unknown as GetUserProfileArgs;
				if (!args.user_id) {
