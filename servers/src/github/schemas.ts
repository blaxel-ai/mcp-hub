...
export const GitHubContentSchema = z.union([GitHubFileContentSchema, z.array(GitHubDirectoryContentSchema)]);
...
export const SearchCodeItemSchema = z.object({
	...
	repository: GitHubRepositorySchema.describe('The repository where this file was found'),
...
export const SearchIssueItemSchema = z.object({
	...
	repository_url: z.string().describe('The API URL for the repository where this issue was found'),
	...
	assignee: GitHubIssueAssigneeSchema.nullable().describe('The assignee of this issue'),
	assignees: z.array(GitHubIssueAssigneeSchema).describe('The assignees of this issue'),
...
export const SearchUserItemSchema = z.object({
	...
	starred_url: z.string().describe('The API URL for starred repositories of this user'),
	subscriptions_url: z.string().describe('The API URL for subscriptions of this user'),
	organizations_url: z.string().describe('The API URL for organizations of this user'),
	...
	received_events_url: z.string().describe('The API URL for received events of this user'),
...
export const SearchCodeSchema = z.object({
	q: z
		.string()
		.describe('Search query. See GitHub code search syntax: https://docs.github.com/en/search-github/searching-on-github/searching-code'),
...
export const SearchUsersSchema = z.object({
	q: z
		.string()
		.describe('Search query. See GitHub users search syntax: https://docs.github.com/en/search-github/searching-on-github/searching-users'),
